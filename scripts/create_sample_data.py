...
from suca.db.db import engine, init_db
from suca.db.model import Entry, Kanji, Reading, Sense, Gloss
    ...
    with Session(engine) as session:
        ...
        sample_entries = [
            ...
            },
            {
                ...
                'senses': [{
                    'pos': 'noun',
                    'glosses': ['execution', 'implementation']
                }]
            },
            {
                'ent_seq': 1000006,
        ...
        # Test a few searches
        from suca.services.search_service import SearchService
        from suca.schemas.search import SearchRequest
